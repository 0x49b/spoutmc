            ...
            <ModalBody>
                ...
                >
                    {formError && (
                        <FormHelperText>
                            <span
                                style={{color: 'var(--pf-v6-global--danger-color--100)'}}>{formError}</span>
                        </FormHelperText>
                    )}
                    ...
                    <FormGroup label="Description" fieldId="plugin-desc">
                        <TextArea id="plugin-desc" value={description}
                                  onChange={(_e, v) => setDescription(v)} rows={2}/>
                    </FormGroup>
                    <FormGroup label="Apply to servers" fieldId="plugin-servers">
                        {servers.length === 0 ? (
                            <FormHelperText>No servers in configuration. Add a server
                                first.</FormHelperText>
                        ) : (
                            servers.map((s) => (
                                <Checkbox
                                    key={s.id}
